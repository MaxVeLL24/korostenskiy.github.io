<div class="logo">
    ...
    <a href="index.php"><div class="logo-img"><img src="img/logo.png" alt="Коростень_лого"></div></a>
</div>
<nav>
    ...
    <ul class="slide-element">
        ...
        <li><a type="button" data-toggle="modal" data-target="#myModal3">Паливо</a></li>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form action="main.php" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Ви заходите в розділ "Паливо"</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><span
                                                class="glyphicon glyphicon-log-in"></span></span>
                                <input name="fuelLogin" type="text" class="form-control" placeholder="Логін"
                                       aria-describedby="basic-addon1"></div>
                        </div>
                        <br>
                        <br>
                        <div class="col-md-12">
                            <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon2"><span
                                                class="glyphicon glyphicon-alert"></span></span>
                                <input name="fuelPassword" type="password" class="form-control" placeholder="Пароль"
                                       aria-describedby="basic-addon1"></div>
                        </div>
                    </div>
                </div>
